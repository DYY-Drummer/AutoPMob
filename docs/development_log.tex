...
%----------------------------------------------------------------------
\begin{itemize}[nosep]
  \item 2026-03-30：Claude Code 等への開発移行用にリポジトリ直下に \texttt{CLAUDE.md} を追加（研究目的・データ構造・実験結論・スクリプト対応・運用ルールを集約）。\texttt{research\_context.md} は \texttt{CLAUDE.md} へのポインタを記載。
