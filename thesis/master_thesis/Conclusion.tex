...
\begin{itemize}
  ...
  \begin{itemize}
    \item Contributions: (1) a solvable-by-construction dataset (11,146 equations, DAE cases, stratified source-disjoint split); (2) a set-aware two-stage retrieval method (+0.22 Recall@K over classical IR, superior to LLM direct generation); (3) a mechanism analysis with causal confirmation via learned greedy selection and a closure guarantee via self-terminating DoF-stop.
  \end{itemize}
